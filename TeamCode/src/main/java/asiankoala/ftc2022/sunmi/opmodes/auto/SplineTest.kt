...
class SplineTest : KOpMode() {
    ...
    fun getGVFCmd(
        sunmi: Sunmi,
        path: Path
    ) = GVFCmd(sunmi.drive, BasedGVFController(path, sunmi.drive, SimpleGVFConstants.kN, SimpleGVFConstants.kOmega, SimpleGVFConstants.kF, SimpleGVFConstants.kS, SimpleGVFConstants.epsilon, SimpleGVFConstants.thetaEpsilon))
    ...
    override fun mInit() {
        ...
        + SequentialGroup(
            ...
            LoopCmd({ Logger.addTelemetryLine("AAAAAAAAAAAAAA") })
        )
    }
}
