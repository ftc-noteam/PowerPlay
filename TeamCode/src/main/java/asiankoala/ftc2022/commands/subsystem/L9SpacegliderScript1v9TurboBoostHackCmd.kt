...
class L9SpacegliderScript1v9TurboBoostHackCmd(
    ...
    private val l9 = L9SpacegliderScript1v9TurboBoostHack(ps, R, N, H)
    ...
    private fun processPowers(): Pose {
        ...
        if(isGliding.invoke()) output = output * W + l9.spaceglide((raws restrict 2).as2dVec) * (1.0 - W)
        output push if(isAimbotting.invoke()) l9.aimbot((raws restrict 2).as2dVec) else pre[3]
