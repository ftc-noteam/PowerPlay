...
class MiyukiBlueCloseAuto : MiyukiAuto(Alliance.BLUE, true)

@Autonomous(name = "\uD83E\uDD76 FAR")
class MiyukiBlueFarAuto : MiyukiAuto(Alliance.BLUE, false)

@Autonomous(name = "\uD83E\uDD75 CLOSE")
class MiyukiRedCloseAuto : MiyukiAuto(Alliance.RED, true)
